...
@Component({
    selector: "app-user-migration-chart",
    templateUrl: "./user-migration-chart.component.html",
    styleUrls: ["./user-migration-chart.component.scss"],
})
export class UserMigrationChartComponent implements OnInit, OnDestroy {
    ...
    screenCaption: string = "User Migrations - Since 1 month ago";
