...
@Component({
  selector: 'app-total-screen-10',
  templateUrl: './total-screen-10.component.html',
  styleUrls: ['./total-screen-10.component.scss']
})
export class TotalScreen10Component implements OnInit, OnDestroy {
