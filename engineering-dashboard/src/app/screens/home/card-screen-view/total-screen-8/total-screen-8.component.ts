...
@Component({
  selector: 'app-total-screen-8',
  templateUrl: './total-screen-8.component.html',
  styleUrls: ['./total-screen-8.component.scss']
})
export class TotalScreen8Component implements OnInit, OnDestroy {
