...
@Component({
  selector: 'app-total-screen-6',
  templateUrl: './total-screen-6.component.html',
  styleUrls: ['./total-screen-6.component.scss']
})
export class TotalScreen6Component implements OnInit, OnDestroy {
