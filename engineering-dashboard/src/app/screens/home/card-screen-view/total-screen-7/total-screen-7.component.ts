...
@Component({
  selector: 'app-total-screen-7',
  templateUrl: './total-screen-7.component.html',
  styleUrls: ['./total-screen-7.component.scss']
})
export class TotalScreen7Component implements OnInit, OnDestroy {
