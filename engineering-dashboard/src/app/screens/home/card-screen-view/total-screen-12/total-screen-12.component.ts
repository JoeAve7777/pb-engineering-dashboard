...
@Component({
  selector: 'app-total-screen-12',
  templateUrl: './total-screen-12.component.html',
  styleUrls: ['./total-screen-12.component.scss']
})
export class TotalScreen12Component implements OnInit, OnDestroy {
