...
@Component({
  selector: 'app-add-new-user-chart',
  templateUrl: './add-new-user-chart.component.html',
  styleUrls: ['./add-new-user-chart.component.scss']
})
export class AddNewUserChartComponent implements OnInit, OnDestroy {
  ...
  screenCaption: string = "Add New User - Since 1 month ago";
  ...
  data = {
      ...
      datasets: [
          {
              label: "Created by Internally/CS",
              fill: false,
