...
@Component({
  selector: 'app-total-screen-9',
  templateUrl: './total-screen-9.component.html',
  styleUrls: ['./total-screen-9.component.scss']
})
export class TotalScreen9Component implements OnInit, OnDestroy {
